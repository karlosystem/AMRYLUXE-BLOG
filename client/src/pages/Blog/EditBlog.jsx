...
const EditBlog = () => {
  ...
  const formSchema = z.object({
    category: z.string().min(3, "Seleccionar ujna categoria para el Blog."),
    title: z
      .string()
      .min(3, "El titulo del Blog debe tener al menos 3 caracteres."),
    slug: z
      .string()
      .min(3, "El slug del Blog debe tener al menos 3 caracteres"),
    blogContent: z
      .string()
      .min(3, "El contenido del blog debe tener al menos 3 caracteres"),
  });
        ...
        <CardContent>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="mb-3">
                <span className="mb-2 block">Imagen Destacada (800px de ancho - 600px de alto)</span>
                <Dropzone
              ...
              <div className="mb-3">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Blog Contenido</FormLabel>
                      <FormControl>
                        <Editor
                          props={{
